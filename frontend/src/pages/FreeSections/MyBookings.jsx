          ...
          bookings.map((gig) => (
            <tr className="border-t">
              ...
              <td className="p-3 space-x-2">
                ...
                <select className="px-3 py-1 bg-blue-500 text-white rounded-lg" onChange={(e) => statusUpdate(gig.bookingId, e.target.value)}>
                  <option value="Pending" className="px-3 py-1 bg-blue-500 text-white rounded-lg" selected disable>{gig.status}</option>
                  <option value="Pending" className="px-3 py-1 bg-blue-500 text-white rounded-lg">Pending</option>
                  <option value="Completed" className="px-3 py-1 bg-blue-500 text-white rounded-lg">Completed</option>
                </select>
              </td>
            </tr>
          ))
